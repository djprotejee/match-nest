...
ENTITIES: dict[str, Entity] = {
    ...
    "italian_f4": Entity("italian_f4", "Italian F4 Championship", Sport.FORMULA, EntityKind.COMPETITION, "#F97316"),
...
DEFAULT_PREFERENCES = UserPreferences(
    follows={
        ...
        "bondarev": Follow("bondarev", FollowLevel.STARRED),
        "italian_f4": Follow("italian_f4", FollowLevel.STARRED),
